...
(function() {
  ...
  function showPersonalizedWelcome(user) {
    ...
    welcome.innerHTML =
      ...
      '<a href="./spa/command-center" style="color:#34d399;text-decoration:none;font-weight:600;">\u2192 Resume</a>';
  ...
  function initHomeFAB() {
    ...
    fab.innerHTML =
      ...
      '<div id="home-fab-menu">' +
        '<a href="./spa/command-center" class="home-fab-item"><div class="home-fab-item-icon" style="background:rgba(16,185,129,0.15);">\u26a1</div>Launch Command Center</a>' +
        '<a href="./spa/command-center" class="home-fab-item" onclick="sessionStorage.setItem(\'cc-open-globe\',\'1\')"><div class="home-fab-item-icon" style="background:rgba(139,92,246,0.15);">\u{1F30E}</div>View 3D Globe</a>' +
        '<a href="./spa/command-center" class="home-fab-item" onclick="sessionStorage.setItem(\'cc-open-news\',\'1\')"><div class="home-fab-item-icon" style="background:rgba(220,38,38,0.15);">\u{1F4F0}</div>Read Latest News</a>' +
        '<a href="./spa/command-center" class="home-fab-item" onclick="sessionStorage.setItem(\'cc-open-fx\',\'1\')"><div class="home-fab-item-icon" style="background:rgba(5,150,105,0.15);">\u{1F4B9}</div>Check FX Rates</a>' +
        '<a href="./spa/command-center" class="home-fab-item" onclick="sessionStorage.setItem(\'cc-open-weather\',\'1\')"><div class="home-fab-item-icon" style="background:rgba(2,132,199,0.15);">\u{1F326}</div>Port Weather</a>' +
      '</div>' +
  ...
  function interceptLogin() {
    ...
    forms.forEach(function(form) {
      ...
      form.addEventListener('submit', function(e) {
        ...
        window.location.href = './spa/command-center';
      });
    });
